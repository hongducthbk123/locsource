...
public abstract class AbstractScheduledService implements Service {
    ...
    public final AbstractService delegate = new AbstractService() {
        ...
        public final Runnable task = new Runnable() {
            public void run() {
                C17151.this.lock.lock();
                try {
                    AbstractScheduledService.this.runOneIteration();
                    C17151.this.lock.unlock();
                } catch (Throwable th) {
                    C17151.this.lock.unlock();
                    throw th;
                }
        ...
        public final void doStart() {
            this.executorService = MoreExecutors.renamingDecorator(AbstractScheduledService.this.executor(), (Supplier<String>) new Supplier<String>() {
                public String get() {
                    return AbstractScheduledService.this.serviceName() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + C17151.this.state();
                }
            });
            this.executorService.execute(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        C17151.this.runningTask = AbstractScheduledService.this.scheduler().schedule(AbstractScheduledService.this.delegate, C17151.this.executorService, C17151.this.task);
                        C17151.this.notifyStarted();
                        C17151.this.lock.unlock();
                    } catch (Throwable th) {
                        C17151.this.lock.unlock();
                        throw th;
        ...
        public final void doStop() {
            ...
            this.executorService.execute(new Runnable() {
                public void run() {
                    try {
                        C17151.this.lock.lock();
                        if (C17151.this.state() != State.STOPPING) {
                            C17151.this.lock.unlock();
                            return;
                        }
                        AbstractScheduledService.this.shutDown();
                        C17151.this.lock.unlock();
                        C17151.this.notifyStopped();
                    } catch (Throwable t) {
                        C17151.this.notifyFailed(t);
