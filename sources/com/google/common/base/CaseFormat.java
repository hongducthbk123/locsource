...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m1479is('-'), Constants.FILENAME_SEQUENCE_SEPARATOR) {
    ...
    LOWER_UNDERSCORE(CharMatcher.m1479is('_'), "_") {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String word) {
            return Ascii.toLowerCase(word);
        }
    ...
    UPPER_UNDERSCORE(CharMatcher.m1479is('_'), "_") {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String word) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String s) {
            ...
            return this.sourceFormat.mo14347to(this.targetFormat, s);
        }
        ...
        public String doBackward(String s) {
            ...
            return this.targetFormat.mo14347to(this.sourceFormat, s);
        }
    ...
    /* renamed from: to */
    public final String mo14347to(CaseFormat format, String str) {
