...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    public final Optional<E> first() {
        ...
        return iterator.hasNext() ? Optional.m1487of(iterator.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (this.iterable instanceof List) {
            ...
            return Optional.m1487of(list.get(list.size() - 1));
        }
        Iterator<E> iterator = this.iterable.iterator();
        if (!iterator.hasNext()) {
            return Optional.absent();
        ...
        if (this.iterable instanceof SortedSet) {
            return Optional.m1487of(((SortedSet) this.iterable).last());
        }
        do {
            current = iterator.next();
        } while (iterator.hasNext());
        return Optional.m1487of(current);
    }
