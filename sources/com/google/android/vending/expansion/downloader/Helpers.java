...
public class Helpers {
    ...
    public static boolean isFilenameValid(String filename) {
        String filename2 = filename.replaceFirst("/+", HttpUtils.PATHS_SEPARATOR);
    ...
    public static int getDownloaderStringResourceIDFromState(int state) {
        switch (state) {
            case 1:
                return C0691R.string.state_idle;
            case 2:
                return C0691R.string.state_fetching_url;
            case 3:
                return C0691R.string.state_connecting;
            case 4:
                return C0691R.string.state_downloading;
            case 5:
                return C0691R.string.state_completed;
            case 6:
                return C0691R.string.state_paused_network_unavailable;
            case 7:
                return C0691R.string.state_paused_by_request;
            case 8:
                return C0691R.string.state_paused_wifi_disabled;
            case 9:
                return C0691R.string.state_paused_wifi_unavailable;
            case 10:
                return C0691R.string.state_paused_wifi_disabled;
            case 11:
                return C0691R.string.state_paused_wifi_unavailable;
            case 12:
                return C0691R.string.state_paused_roaming;
            case 13:
                return C0691R.string.state_paused_network_setup_failure;
            case 14:
                return C0691R.string.state_paused_sdcard_unavailable;
            case 15:
                return C0691R.string.state_failed_unlicensed;
            case 16:
                return C0691R.string.state_failed_fetching_url;
            case 17:
                return C0691R.string.state_failed_sdcard_full;
            case 18:
                return C0691R.string.state_failed_cancelled;
            default:
                return C0691R.string.state_unknown;
        }
    }
}
