...
public class BtsdkLog {
    public static String TAG = "BtsdkLog";

    /* renamed from: v */
    public static void m1434v(String format, Object... args) {
    ...
    /* renamed from: d */
    public static void m1429d(String format) {
        if (DebugUtils.getInstance().isLogFlag()) {
    ...
    /* renamed from: e */
    public static void m1431e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m1432e(Throwable tr, String format, Object... args) {
        if (DebugUtils.getInstance().isLogFlag()) {
    ...
    /* renamed from: e */
    public static void m1430e(String message) {
        if (DebugUtils.getInstance().isLogFlag()) {
    ...
    /* renamed from: p */
    public static void m1433p(String key, String value) {
        if (DebugUtils.getInstance().isLogFlag()) {
