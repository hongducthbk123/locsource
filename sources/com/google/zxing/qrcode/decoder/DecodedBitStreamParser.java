...
final class DecodedBitStreamParser {
    ...
    private static void decodeKanjiSegment(BitSource bits, StringBuilder result, int count) throws FormatException {
        ...
        while (count > 0) {
            int twoBytes = bits.readBits(13);
            int assembledTwoBytes = ((twoBytes / DownloaderService.STATUS_RUNNING) << 8) | (twoBytes % DownloaderService.STATUS_RUNNING);
    ...
    private static int parseECIValue(BitSource bits) throws FormatException {
        ...
        if ((firstByte & DownloaderService.STATUS_RUNNING) == 128) {
