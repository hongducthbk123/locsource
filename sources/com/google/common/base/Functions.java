...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f982f;

        /* renamed from: g */
        private final Function<B, C> f983g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f983g = (Function) Preconditions.checkNotNull(g);
            this.f982f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(@Nullable A a) {
            return this.f983g.apply(this.f982f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (!this.f982f.equals(that.f982f) || !this.f983g.equals(that.f983g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f982f.hashCode() ^ this.f983g.hashCode();
        }

        public String toString() {
            return this.f983g + "(" + this.f982f + ")";
        }
    }
