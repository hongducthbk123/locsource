...
import com.baitian.datasdk.util.CodecUtils;
...
public class HttpDataUtil {
    ...
    public static String readJsonData(InputStream in) {
        ...
        try {
            ...
            BtsdkLog.m1417d("uncompress " + e2.getMessage());
            e2.printStackTrace();
            try {
        ...
        BtsdkLog.m1417d("decode respone");
        if (tmp == null || tmp.length() <= 0) {
            return null;
        }
        BtsdkLog.m1417d("respone = " + tmp);
        return tmp;
    }
