...
public final class Code39Reader extends OneDReader {
    ...
    static {
        int[] iArr = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, DownloaderService.STATUS_PAUSED_BY_APP, 448, 145, 400, 208, 133, 388, DownloaderService.STATUS_QUEUED_FOR_WIFI_OR_CELLULAR_PERMISSION, 148, 168, 162, 138, 42};
        ...
        if (nextStart == end || (whiteSpaceAfterEnd << 1) >= lastPatternSize) {
            if (this.usingCheckDigit) {
                ...
                for (int i3 = 0; i3 < max; i3++) {
                    total += CHECK_DIGIT_STRING.indexOf(this.decodeRowResult.charAt(i3));
                }
