...
public class DeviceRequestsHelper {
    ...
    private static boolean startAdvertisementServiceImpl(final String userCode) {
        if (!deviceRequestsListeners.containsKey(userCode)) {
            final String nsdServiceName = String.format("%s_%s_%s", new Object[]{SDK_HEADER, String.format("%s-%s", new Object[]{SDK_FLAVOR, FacebookSdk.getSdkVersion().replace(FilenameUtils.EXTENSION_SEPARATOR, '|')}), userCode});
