...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m1500on(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m1602of(String resourceName2, ClassLoader loader2) {
    ...
    static final class Scanner {
        ...
        private void scanDirectory(File directory, ClassLoader classloader) throws IOException {
            scanDirectory(directory, classloader, "", ImmutableSet.m1549of());
        }
        ...
        private void scanDirectory(File directory, ClassLoader classloader, String packagePrefix, ImmutableSet<File> ancestors) throws IOException {
            ...
            if (!ancestors.contains(canonical)) {
                ...
                for (File f : files) {
                    ...
                    if (f.isDirectory()) {
                        scanDirectory(f, classloader, packagePrefix + name + HttpUtils.PATHS_SEPARATOR, newAncestors);
                    } else {
                        String resourceName = packagePrefix + name;
                        if (!resourceName.equals("META-INF/MANIFEST.MF")) {
                            this.resources.add((Object) ResourceInfo.m1602of(resourceName, classloader));
                        }
                    }
                }
            }
                ...
                try {
                    ...
                    while (entries.hasMoreElements()) {
                        ...
                        if (!entry.isDirectory() && !entry.getName().equals("META-INF/MANIFEST.MF")) {
                            this.resources.add((Object) ResourceInfo.m1602of(entry.getName(), classloader));
                        }
                    }
                } finally {
                    try {
        ...
        static URI getClassPathEntry(File jarFile, String path) throws URISyntaxException {
            ...
            return uri.isAbsolute() ? uri : new File(jarFile.getParentFile(), path.replace(IOUtils.DIR_SEPARATOR_UNIX, File.separatorChar)).toURI();
        }
    }
