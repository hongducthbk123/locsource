...
public abstract class CharMatcher implements Predicate<Character> {
    public static final CharMatcher ANY = new FastMatcher("CharMatcher.ANY") {
        ...
        /* renamed from: or */
        public CharMatcher mo13944or(CharMatcher other) {
    ...
    public static final CharMatcher JAVA_ISO_CONTROL = inRange(0, 31).mo13944or(inRange(Ascii.MAX, 159)).withToString("CharMatcher.JAVA_ISO_CONTROL");
    ...
    private static class C1260Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1260Or(CharMatcher a, CharMatcher b, String description) {
            super(description);
            this.first = (CharMatcher) Preconditions.checkNotNull(a);
            this.second = (CharMatcher) Preconditions.checkNotNull(b);
        }

        C1260Or(CharMatcher a, CharMatcher b) {
        ...
        /* access modifiers changed from: 0000 */
        public CharMatcher withToString(String description) {
            return new C1260Or(this.first, this.second, description);
        }
    }
    ...
    /* renamed from: is */
    public static CharMatcher m1450is(final char match) {
        return new FastMatcher("CharMatcher.is('" + showCharacter(match) + "')") {
            ...
            /* renamed from: or */
            public CharMatcher mo13944or(CharMatcher other) {
                return other.matches(match) ? other : super.mo13944or(other);
            }
    ...
    public static CharMatcher anyOf(CharSequence sequence) {
        switch (sequence.length()) {
            case 0:
                return NONE;
            case 1:
                return m1450is(sequence.charAt(0));
            case 2:
    ...
    /* renamed from: or */
    public CharMatcher mo13944or(CharMatcher other) {
        return new C1260Or(this, (CharMatcher) Preconditions.checkNotNull(other));
    }
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description2) {
        switch (totalCharacters) {
            case 0:
                return NONE;
            case 1:
                return m1450is((char) table.nextSetBit(0));
            case 2:
