...
public final class MimeTypeFilter {
    ...
    public static boolean matches(@Nullable String mimeType, @NonNull String filter) {
        ...
        return mimeTypeAgainstFilter(mimeType.split(HttpUtils.PATHS_SEPARATOR), filter.split(HttpUtils.PATHS_SEPARATOR));
    }
    ...
    public static String matches(@Nullable String mimeType, @NonNull String[] filters) {
        ...
        String[] mimeTypeParts = mimeType.split(HttpUtils.PATHS_SEPARATOR);
        for (String filter : filters) {
            if (mimeTypeAgainstFilter(mimeTypeParts, filter.split(HttpUtils.PATHS_SEPARATOR))) {
                return filter;
            }
        }
        return null;
    ...
    public static String matches(@Nullable String[] mimeTypes, @NonNull String filter) {
        ...
        String[] filterParts = filter.split(HttpUtils.PATHS_SEPARATOR);
        for (String mimeType : mimeTypes) {
            if (mimeTypeAgainstFilter(mimeType.split(HttpUtils.PATHS_SEPARATOR), filterParts)) {
                return mimeType;
            }
        }
        return null;
