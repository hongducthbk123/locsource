...
public class EndianUtils {
    ...
    public static int readSwappedInteger(byte[] data, int offset) {
        return ((data[offset + 0] & 255) << 0) + ((data[offset + 1] & 255) << 8) + ((data[offset + 2] & 255) << Ascii.DLE) + ((data[offset + 3] & 255) << Ascii.CAN);
    }

    public static long readSwappedUnsignedInteger(byte[] data, int offset) {
        return (((long) (data[offset + 3] & 255)) << 24) + (4294967295L & ((long) (((data[offset + 0] & 255) << 0) + ((data[offset + 1] & 255) << 8) + ((data[offset + 2] & 255) << Ascii.DLE))));
    }
