...
public final class HttpRequest {
    ...
    /* JADX WARNING: type inference failed for: r1v19, types: [com.google.api.client.util.StreamingContent] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:144:0x0410  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:169:0x0332 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:83:0x02e6 A[SYNTHETIC, Splitter:B:83:0x02e6] */
    ...
    public com.google.api.client.http.HttpResponse execute() throws java.io.IOException {
        ...
        L_0x00fa:
            ...
            com.google.api.client.http.HttpHeaders r0 = r0.headers
            r34 = r0
            java.lang.String r35 = "Google-HTTP-Java-Client/1.22.0 (gzip)"
        ...
        L_0x0190:
            ...
            java.lang.StringBuilder r34 = r34.append(r35)
            r0 = r34
            java.lang.StringBuilder r34 = r0.append(r12)
        ...
        L_0x01da:
            ...
            java.lang.StringBuilder r34 = r34.append(r35)
            r0 = r34
            java.lang.StringBuilder r34 = r0.append(r8)
            java.lang.String r17 = r34.toString()
            r0 = r18
            r1 = r17
            java.lang.StringBuilder r34 = r0.append(r1)
        ...
        L_0x02ad:
            ...
            r2 = r35
            r0.setTimeout(r1, r2)
            com.google.api.client.http.LowLevelHttpResponse r23 = r22.execute()     // Catch:{ IOException -> 0x03a1 }
            r27 = 0
            com.google.api.client.http.HttpResponse r26 = new com.google.api.client.http.HttpResponse     // Catch:{ all -> 0x0394 }
            r0 = r26
            r1 = r37
            r2 = r23
            r0.<init>(r1, r2)     // Catch:{ all -> 0x0394 }
            r27 = 1
            if (r27 != 0) goto L_0x02e0
            java.io.InputStream r21 = r23.getContent()     // Catch:{ IOException -> 0x0457 }
            if (r21 == 0) goto L_0x02e0
            r21.close()     // Catch:{ IOException -> 0x0457 }
        L_0x02e0:
            r25 = r26
        L_0x02e2:
            r28 = 0
            if (r25 == 0) goto L_0x040e
            boolean r34 = r25.isSuccessStatusCode()     // Catch:{ all -> 0x0419 }
            if (r34 != 0) goto L_0x040e
            r15 = 0
            r0 = r37
            com.google.api.client.http.HttpUnsuccessfulResponseHandler r0 = r0.unsuccessfulResponseHandler     // Catch:{ all -> 0x0419 }
            r34 = r0
            if (r34 == 0) goto L_0x0307
            r0 = r37
            com.google.api.client.http.HttpUnsuccessfulResponseHandler r0 = r0.unsuccessfulResponseHandler     // Catch:{ all -> 0x0419 }
            r34 = r0
            r0 = r34
            ...
            r2 = r25
            r3 = r30
            boolean r15 = r0.handleResponse(r1, r2, r3)     // Catch:{ all -> 0x0419 }
        L_0x0307:
            if (r15 != 0) goto L_0x031e
            int r34 = r25.getStatusCode()     // Catch:{ all -> 0x0419 }
            com.google.api.client.http.HttpHeaders r35 = r25.getHeaders()     // Catch:{ all -> 0x0419 }
            r0 = r37
            r1 = r34
            r2 = r35
            boolean r34 = r0.handleRedirect(r1, r2)     // Catch:{ all -> 0x0419 }
            if (r34 == 0) goto L_0x03d6
            r15 = 1
        L_0x031e:
            r30 = r30 & r15
            if (r30 == 0) goto L_0x0325
            r25.ignore()     // Catch:{ all -> 0x0419 }
        L_0x0325:
            int r29 = r29 + -1
            r28 = 1
        ...
        L_0x033d:
            ...
            java.lang.String r36 = "Google-HTTP-Java-Client/1.22.0 (gzip)"
            java.lang.StringBuilder r35 = r35.append(r36)
        ...
        L_0x0394:
            r34 = move-exception
            if (r27 != 0) goto L_0x03a0
            java.io.InputStream r21 = r23.getContent()     // Catch:{ IOException -> 0x03a1 }
            if (r21 == 0) goto L_0x03a0
            r21.close()     // Catch:{ IOException -> 0x03a1 }
        L_0x03a0:
            throw r34     // Catch:{ IOException -> 0x03a1 }
        L_0x03a1:
            r14 = move-exception
        L_0x03a2:
            r0 = r37
        ...
        L_0x03d6:
            ...
            r0 = r37
            com.google.api.client.http.BackOffPolicy r0 = r0.backOffPolicy     // Catch:{ all -> 0x0419 }
            r34 = r0
            if (r34 == 0) goto L_0x031e
            r0 = r37
            com.google.api.client.http.BackOffPolicy r0 = r0.backOffPolicy     // Catch:{ all -> 0x0419 }
            r34 = r0
            int r35 = r25.getStatusCode()     // Catch:{ all -> 0x0419 }
            boolean r34 = r34.isBackOffRequired(r35)     // Catch:{ all -> 0x0419 }
            if (r34 == 0) goto L_0x031e
            r0 = r37
            com.google.api.client.http.BackOffPolicy r0 = r0.backOffPolicy     // Catch:{ all -> 0x0419 }
            r34 = r0
            long r6 = r34.getNextBackOffMillis()     // Catch:{ all -> 0x0419 }
            r34 = -1
            int r34 = (r6 > r34 ? 1 : (r6 == r34 ? 0 : -1))
            if (r34 == 0) goto L_0x031e
            r0 = r37
            com.google.api.client.util.Sleeper r0 = r0.sleeper     // Catch:{ InterruptedException -> 0x0455 }
            r34 = r0
            r0 = r34
            r0.sleep(r6)     // Catch:{ InterruptedException -> 0x0455 }
        L_0x040b:
            r15 = 1
            goto L_0x031e
        L_0x040e:
        ...
        L_0x0437:
            ...
            if (r34 != 0) goto L_0x0454
            com.google.api.client.http.HttpResponseException r34 = new com.google.api.client.http.HttpResponseException     // Catch:{ all -> 0x044f }
            r0 = r34
            r1 = r25
            r0.<init>(r1)     // Catch:{ all -> 0x044f }
            throw r34     // Catch:{ all -> 0x044f }
        L_0x044f:
            r34 = move-exception
            r25.disconnect()
            throw r34
