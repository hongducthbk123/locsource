...
class PackageBuilder {
    ...
    public PackageBuilder(AdjustConfig adjustConfig2, DeviceInfo deviceInfo2, ActivityState activityState, SessionParameters sessionParameters2, long createdAt2) {
    ...
    private void injectDeviceInfo(Map<String, String> parameters) {
        ...
        addString(parameters, "mcc", Util.getMcc(this.adjustConfig.context));
        addString(parameters, "mnc", Util.getMnc(this.adjustConfig.context));
    ...
    private void injectCommonParameters(Map<String, String> parameters) {
        addDateInMilliseconds(parameters, DbAdapter.KEY_CREATED_AT, this.createdAt);
