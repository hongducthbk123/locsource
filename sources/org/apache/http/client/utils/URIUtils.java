...
public class URIUtils {
    ...
    public static URI resolve(URI baseURI, URI reference) {
        ...
        if (baseURI == null) {
            ...
            if (s.startsWith(HttpUtils.URL_AND_PARA_SEPARATOR)) {
    ...
    private static URI removeDotSegments(URI uri) {
        ...
        String[] inputSegments = path.split(HttpUtils.PATHS_SEPARATOR);
        ...
        while (i$.hasNext()) {
            outputBuffer.append(IOUtils.DIR_SEPARATOR_UNIX).append((String) i$.next());
        }
        try {
