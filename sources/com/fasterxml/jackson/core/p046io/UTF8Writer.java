...
public final class UTF8Writer extends Writer {
    ...
    public void write(char[] r13, int r14, int r15) throws java.io.IOException {
        ...
        L_0x00f1:
            ...
            goto L_0x00ac
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p046io.UTF8Writer.write(char[], int, int):void");
    }
    ...
    public void write(int c) throws IOException {
        ...
        if (c < 2048) {
            int ptr3 = ptr2 + 1;
            this._outBuffer[ptr2] = (byte) ((c >> 6) | DownloaderService.STATUS_RUNNING);
            ptr = ptr3 + 1;
        ...
        if (len >= 2) {
            ...
            while (true) {
                ...
                if (c < 2048) {
                    ...
                    outBuf[outPtr] = (byte) ((c >> 6) | DownloaderService.STATUS_RUNNING);
