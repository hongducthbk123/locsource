...
class AppCompatTextHelperV17 extends AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0247R.styleable.AppCompatTextHelper_android_drawableStart)) {
            this.mDrawableStartTint = createTintInfo(context, drawableManager, a.getResourceId(C0247R.styleable.AppCompatTextHelper_android_drawableStart, 0));
        }
        if (a.hasValue(C0247R.styleable.AppCompatTextHelper_android_drawableEnd)) {
            this.mDrawableEndTint = createTintInfo(context, drawableManager, a.getResourceId(C0247R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
        }
        a.recycle();
    }
