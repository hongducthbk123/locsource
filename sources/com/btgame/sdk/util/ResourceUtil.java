...
public class ResourceUtil {
    ...
    public static int getTransitionId(Context paramContext, String paramString) {
        return paramContext.getResources().getIdentifier(paramString, "transition", paramContext.getPackageName());
    }

    public static int getStyleId(Context paramContext, String paramString) {
        return paramContext.getResources().getIdentifier(paramString, AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE, paramContext.getPackageName());
    }
