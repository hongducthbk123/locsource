...
public class Credential implements HttpExecuteInterceptor, HttpRequestInitializer, HttpUnsuccessfulResponseHandler {
    ...
    public boolean handleResponse(com.google.api.client.http.HttpRequest r11, com.google.api.client.http.HttpResponse r12, boolean r13) {
        ...
        L_0x003c:
            ...
            java.util.concurrent.locks.Lock r8 = r10.lock     // Catch:{ IOException -> 0x0068 }
            r8.lock()     // Catch:{ IOException -> 0x0068 }
            java.lang.String r8 = r10.accessToken     // Catch:{ all -> 0x0061 }
            com.google.api.client.auth.oauth2.Credential$AccessMethod r9 = r10.method     // Catch:{ all -> 0x0061 }
            java.lang.String r9 = r9.getAccessTokenFromRequest(r11)     // Catch:{ all -> 0x0061 }
            boolean r8 = com.google.api.client.util.Objects.equal(r8, r9)     // Catch:{ all -> 0x0061 }
            if (r8 == 0) goto L_0x0057
            boolean r8 = r10.refreshToken()     // Catch:{ all -> 0x0061 }
