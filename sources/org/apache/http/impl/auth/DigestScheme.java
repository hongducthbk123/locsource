...
public class DigestScheme extends RFC2617Scheme {
    ...
    /* renamed from: NC */
    private static final String f1726NC = "00000001";
    ...
    private String createDigest(Credentials credentials) throws AuthenticationException {
        ...
        if (uri == null) {
            ...
            if (algorithm.equalsIgnoreCase("MD5-sess")) {
                String algorithm2 = Constants.MD5;
            ...
            if (this.qopVariant == 0) {
                ...
                StringBuilder sb4 = new StringBuilder(hasha1.length() + nonce.length() + f1726NC.length() + cnonce3.length() + qopOption.length() + hasha2.length() + 5);
                sb4.append(hasha1);
                sb4.append(':');
                sb4.append(nonce);
                sb4.append(':');
    ...
    private Header createDigestHeader(Credentials credentials, String digest) {
        ...
        params.add(new BasicNameValuePair(ShareConstants.MEDIA_URI, uri));
        params.add(new BasicNameValuePair("response", response));
        if (this.qopVariant != 0) {
            params.add(new BasicNameValuePair("qop", getQopVariantString()));
            params.add(new BasicNameValuePair("nc", f1726NC));
    ...
    public static String createCnonce() {
        return encode(createMessageDigest(Constants.MD5).digest(EncodingUtils.getAsciiBytes(Long.toString(System.currentTimeMillis()))));
    }
}
