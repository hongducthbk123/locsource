...
/* renamed from: cn.jiguang.api.BasePreferenceManager */
public abstract class BasePreferenceManager {
    public static final String JPUSH_PREF = "cn.jpush.preferences.v2";
    private static SharedPreferences mSharedPreferences = null;

    protected static void applyBuffer(Context context, C0510a aVar) {
        init(context);
        aVar.mo6678a(mSharedPreferences, true);
    }

    protected static void applyBuffer(C0510a aVar) {
    ...
    protected static void commitStringWithEncryption(String str, String str2) {
        Editor edit = mSharedPreferences.edit();
        edit.putString(str, C0480a.m776a(str2));
        edit.apply();
    }
    ...
    protected static String getStringUnencrypted(String str, String str2) {
        return C0480a.m784b(mSharedPreferences.getString(str, str2), str2);
    }
