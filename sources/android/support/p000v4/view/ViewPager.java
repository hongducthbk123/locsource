        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (lp2 == null || !lp2.isDecor) {
                    child2.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp2.widthFactor), Ints.MAX_POWER_OF_TWO), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp2.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp2.needsMeasure) {
                            ...
                            child2.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp2.widthFactor), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                        }
