...
public final class DateTime implements Serializable {
    ...
    public String toStringRfc3339() {
        ...
        dateTime.setTimeInMillis(this.value + (((long) this.tzShift) * Constants.WATCHDOG_WAKE_TIMER));
    ...
    public static DateTime parseRfc3339(String str) throws NumberFormatException {
        ...
        if (!matcher.matches()) {
            NumberFormatException numberFormatException = new NumberFormatException("Invalid date/time format: " + str);
        ...
        if (!isTzShiftGiven || isTimeGiven) {
            ...
            if (isTimeGiven && isTzShiftGiven) {
                if (Character.toUpperCase(tzShiftRegexGroup.charAt(0)) == 'Z') {
                    ...
                    value2 -= ((long) tzShift2) * Constants.WATCHDOG_WAKE_TIMER;
                }
        ...
        NumberFormatException numberFormatException2 = new NumberFormatException("Invalid date/time format, cannot specify time zone shift without specifying time: " + str);
