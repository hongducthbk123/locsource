...
public final class MediaHttpUploader {
    ...
    /* renamed from: KB */
    private static final int f960KB = 1024;

    /* renamed from: MB */
    static final int f961MB = 1048576;
    ...
    private void setContentAndHeadersOnCurrentRequest() throws IOException {
        ...
        if (actualBlockSize == 0) {
            ...
            this.currentRequest.getHeaders().setContentRange("bytes " + this.totalBytesServerReceived + Constants.FILENAME_SEQUENCE_SEPARATOR + ((this.totalBytesServerReceived + ((long) actualBlockSize)) - 1) + HttpUtils.PATHS_SEPARATOR + this.mediaContentLengthStr);
        }
    }
