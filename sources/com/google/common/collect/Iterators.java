...
public final class Iterators {
    ...
    public static boolean removeAll(Iterator<?> removeFrom, Collection<?> elementsToRemove) {
        return removeIf(removeFrom, Predicates.m1491in(elementsToRemove));
    }
    ...
    public static boolean retainAll(Iterator<?> removeFrom, Collection<?> elementsToRetain) {
        return removeIf(removeFrom, Predicates.not(Predicates.m1491in(elementsToRetain)));
    }
    ...
    public static <T> Iterator<T> cycle(T... elements) {
        return cycle((Iterable<T>) Lists.newArrayList((E[]) elements));
    }

    public static <T> Iterator<T> concat(Iterator<? extends T> a, Iterator<? extends T> b) {
        return concat((Iterator<? extends Iterator<? extends T>>) ImmutableList.m1513of(a, b).iterator());
    }

    public static <T> Iterator<T> concat(Iterator<? extends T> a, Iterator<? extends T> b, Iterator<? extends T> c) {
        return concat((Iterator<? extends Iterator<? extends T>>) ImmutableList.m1514of(a, b, c).iterator());
    }

    public static <T> Iterator<T> concat(Iterator<? extends T> a, Iterator<? extends T> b, Iterator<? extends T> c, Iterator<? extends T> d) {
        return concat((Iterator<? extends Iterator<? extends T>>) ImmutableList.m1515of(a, b, c, d).iterator());
    }

    public static <T> Iterator<T> concat(Iterator<? extends T>... inputs) {
        return concat((Iterator<? extends Iterator<? extends T>>) ImmutableList.copyOf((E[]) inputs).iterator());
    }
    ...
    public static <T> Optional<T> tryFind(Iterator<T> iterator, Predicate<? super T> predicate) {
        ...
        return filteredIterator.hasNext() ? Optional.m1487of(filteredIterator.next()) : Optional.absent();
    }
