...
public class zzd {
    ...
    @Hide
    private static String[] zzc = {"com.google", "com.google.work", "cn.google"};
    ...
    public static final zzbhf zze = new zzbhf("Auth", "GoogleAuthUtil");
    ...
    public static TokenData zza(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableAuthException, GoogleAuthException {
        ...
        return (TokenData) zza(context, zzd, new zze(account, str, bundle2));
    }

    private static <T> T zza(Context context, ComponentName componentName, zzj<T> zzj) throws IOException, GoogleAuthException {
        zza zza2 = new zza();
        zzag zza3 = zzag.zza(context);
        if (zza3.zza(componentName, (ServiceConnection) zza2, "GoogleAuthUtil")) {
            try {
                T zza4 = zzj.zza(zza2.zza());
                zza3.zzb(componentName, (ServiceConnection) zza2, "GoogleAuthUtil");
                return zza4;
            } catch (RemoteException | InterruptedException e) {
                zze.zzc("GoogleAuthUtil", "Error on service connection.", e);
    ...
    public static <T> T zzb(T t) throws IOException {
        ...
        zze.zzd("GoogleAuthUtil", "Binder call returned null.");
