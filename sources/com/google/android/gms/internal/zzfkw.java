...
final class zzfkw extends zzfkt {
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        switch (i2) {
            case 0:
                return zzfks.zzb(i);
            case 1:
                return zzfks.zzb(i, zzfkq.zza(bArr, j));
            case 2:
                return zzfks.zzb(i, (int) zzfkq.zza(bArr, j), (int) zzfkq.zza(bArr, 1 + j));
            default:
    ...
    private static int zza(byte[] r9, long r10, int r12) {
        ...
        L_0x000c:
            ...
            r2 = 1
            long r2 = r2 + r4
            byte r1 = com.google.android.gms.internal.zzfkq.zza(r9, r4)
        ...
        L_0x001d:
            ...
            r4 = 1
            long r4 = r4 + r2
            byte r1 = com.google.android.gms.internal.zzfkq.zza(r9, r2)
        ...
        L_0x005c:
            ...
            r2 = 1
            long r6 = r4 + r2
            byte r2 = com.google.android.gms.internal.zzfkq.zza(r9, r4)
            r3 = -65
        ...
        L_0x007a:
            r2 = 1
            long r2 = r2 + r6
            byte r1 = com.google.android.gms.internal.zzfkq.zza(r9, r6)
            r4 = -65
            if (r1 <= r4) goto L_0x000a
        L_0x0085:
            r0 = -1
        ...
        L_0x008f:
            ...
            r2 = 1
            long r2 = r2 + r4
            byte r4 = com.google.android.gms.internal.zzfkq.zza(r9, r4)
            r5 = -65
        ...
        L_0x00bb:
            ...
            goto L_0x0032
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzfkw.zza(byte[], long, int):int");
    }
    ...
    public final int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < 128 && j5 < j3) {
                j = 1 + j5;
                zzfkq.zza(bArr, j5, (byte) charAt2);
            } else if (charAt2 < 2048 && j5 <= j3 - 2) {
                long j6 = j5 + 1;
                zzfkq.zza(bArr, j5, (byte) ((charAt2 >>> 6) | 960));
                j = 1 + j6;
                zzfkq.zza(bArr, j6, (byte) ((charAt2 & '?') | 128));
            } else if ((charAt2 < 55296 || 57343 < charAt2) && j5 <= j3 - 3) {
                long j7 = 1 + j5;
                zzfkq.zza(bArr, j5, (byte) ((charAt2 >>> 12) | 480));
                long j8 = 1 + j7;
                zzfkq.zza(bArr, j7, (byte) (((charAt2 >>> 6) & 63) | 128));
                j = 1 + j8;
                zzfkq.zza(bArr, j8, (byte) ((charAt2 & '?') | 128));
            } else if (j5 <= j3 - 4) {
                if (i3 + 1 != length) {
                    i3++;
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        long j9 = 1 + j5;
                        zzfkq.zza(bArr, j5, (byte) ((codePoint >>> 18) | 240));
                        long j10 = 1 + j9;
                        zzfkq.zza(bArr, j9, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j11 = j10 + 1;
                        zzfkq.zza(bArr, j10, (byte) (((codePoint >>> 6) & 63) | 128));
                        j = 1 + j11;
                        zzfkq.zza(bArr, j11, (byte) ((codePoint & 63) | 128));
                    }
                }
