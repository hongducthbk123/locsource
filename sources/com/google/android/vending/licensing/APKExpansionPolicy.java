...
public class APKExpansionPolicy implements Policy {
    ...
    public APKExpansionPolicy(Context context, Obfuscator obfuscator) {
        ...
        this.mValidityTimestamp = Long.parseLong(this.mPreferences.getString(PREF_VALIDITY_TIMESTAMP, AppEventsConstants.EVENT_PARAM_VALUE_NO));
        this.mRetryUntil = Long.parseLong(this.mPreferences.getString(PREF_RETRY_UNTIL, AppEventsConstants.EVENT_PARAM_VALUE_NO));
        this.mMaxRetries = Long.parseLong(this.mPreferences.getString(PREF_MAX_RETRIES, AppEventsConstants.EVENT_PARAM_VALUE_NO));
        this.mRetryCount = Long.parseLong(this.mPreferences.getString(PREF_RETRY_COUNT, AppEventsConstants.EVENT_PARAM_VALUE_NO));
    }

    public void resetPolicy() {
        this.mPreferences.putString(PREF_LAST_RESPONSE, Integer.toString(Policy.RETRY));
        setRetryUntil(AppEventsConstants.EVENT_PARAM_VALUE_NO);
        setMaxRetries(AppEventsConstants.EVENT_PARAM_VALUE_NO);
        setRetryCount(Long.parseLong(AppEventsConstants.EVENT_PARAM_VALUE_NO));
        setValidityTimestamp(AppEventsConstants.EVENT_PARAM_VALUE_NO);
    ...
    public void processServerResponse(int response, ResponseData rawData) {
        ...
        if (response == 256) {
            Map extras = decodeExtras(rawData.extra);
    ...
    private void setRetryUntil(String retryUntil) {
        ...
        try {
            ...
            retryUntil = AppEventsConstants.EVENT_PARAM_VALUE_NO;
    ...
    private void setMaxRetries(String maxRetries) {
        ...
        try {
            ...
            maxRetries = AppEventsConstants.EVENT_PARAM_VALUE_NO;
    ...
    private Map<String, String> decodeExtras(String extras) {
        ...
        try {
            for (NameValuePair item : URLEncodedUtils.parse(new URI(HttpUtils.URL_AND_PARA_SEPARATOR + extras), "UTF-8")) {
