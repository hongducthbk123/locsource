...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m1524of() {
        return EmptyImmutableListMultimap.INSTANCE;
    }

    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m1525of(K k1, V v1) {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m1526of(K k1, V v1, K k2, V v2) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        return builder.build();
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m1527of(K k1, V v1, K k2, V v2, K k3, V v3) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        builder.put(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m1528of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        builder.put(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m1529of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder<K, V> builder = builder();
        builder.put(k1, v1);
        builder.put(k2, v2);
        builder.put(k3, v3);
    ...
    public ImmutableList<V> get(@Nullable K key) {
        ...
        return list == null ? ImmutableList.m1511of() : list;
    }
