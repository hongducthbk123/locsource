...
public class FileUtil {
    ...
    public static String getLogFile() throws IOException {
        ...
        if (!logfile.createNewFile()) {
            BtsdkLog.m1423d("创建Log.txt失败");
            return null;
        }
        BtsdkLog.m1423d("创建Log.txt成功");
        return logfile.getAbsolutePath();
    }
    ...
    public static File makedirInGamedir(String dirName) {
        ...
        BtsdkLog.m1423d("创建" + dirName + "目录失败");
        return null;
    }
    ...
    public static File makeFileInGamedir(String fileName) {
        ...
        try {
            ...
            BtsdkLog.m1423d("创建" + fileName + "文件失败");
            return null;
        } catch (Exception e) {
            e.printStackTrace();
            return custmerFile;
