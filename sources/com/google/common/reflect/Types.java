...
final class Types {
    ...
    public static final Joiner COMMA_JOINER = Joiner.m1486on(", ").useForNull("null");
    /* access modifiers changed from: private */
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            if (this.ownerType != null) {
                builder.append(Types.toString(this.ownerType)).append(FilenameUtils.EXTENSION_SEPARATOR);
            }
    ...
    static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            StringBuilder builder = new StringBuilder(HttpUtils.URL_AND_PARA_SEPARATOR);
