...
public class V14CustomNotification implements ICustomNotification {
    ...
    public void setProgress(Builder builder) {
    }
    ...
    public Notification updateNotification(Context c) {
        ...
        builder.setContentInfo(c.getString(C0691R.string.time_remaining_notification, new Object[]{Helpers.getTimeRemaining(this.mTimeRemaining)}));
        if (this.mIcon != 0) {
