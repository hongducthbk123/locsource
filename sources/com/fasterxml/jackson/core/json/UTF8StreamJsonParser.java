...
public final class UTF8StreamJsonParser extends ParserBase {
    ...
    public int _decodeCharForError(int firstByte) throws IOException, JsonParseException {
        ...
        int d = nextByte();
        if ((d & DownloaderService.STATUS_RUNNING) != 128) {
        ...
        int d2 = nextByte();
        if ((d2 & DownloaderService.STATUS_RUNNING) != 128) {
        ...
        int d3 = nextByte();
        if ((d3 & DownloaderService.STATUS_RUNNING) != 128) {
