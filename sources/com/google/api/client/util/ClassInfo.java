...
public final class ClassInfo {
    ...
    /* renamed from: of */
    public static ClassInfo m1470of(Class<?> underlyingClass) {
        return m1471of(underlyingClass, false);
    }

    /* renamed from: of */
    public static ClassInfo m1471of(Class<?> underlyingClass, boolean ignoreCase2) {
        ClassInfo classInfo;
    ...
    private ClassInfo(Class<?> srcClass, boolean ignoreCase2) {
        ...
        for (Field field : srcClass.getDeclaredFields()) {
            FieldInfo fieldInfo = FieldInfo.m1473of(field);
            if (fieldInfo != null) {
        ...
        if (superClass != null) {
            ClassInfo superClassInfo = m1471of(superClass, ignoreCase2);
