...
public final class FontRequest {
    ...
    public FontRequest(@NonNull String providerAuthority, @NonNull String providerPackage, @NonNull String query, @NonNull List<List<byte[]>> certificates) {
        ...
        this.mIdentifier = new StringBuilder(this.mProviderAuthority).append(Constants.FILENAME_SEQUENCE_SEPARATOR).append(this.mProviderPackage).append(Constants.FILENAME_SEQUENCE_SEPARATOR).append(this.mQuery).toString();
    }
