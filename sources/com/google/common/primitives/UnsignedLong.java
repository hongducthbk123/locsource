...
public final class UnsignedLong extends Number implements Comparable<UnsignedLong>, Serializable {
    ...
    public static UnsignedLong valueOf(long value2) {
        ...
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned long value", Long.valueOf(value2));
    ...
    public static UnsignedLong valueOf(BigInteger value2) {
        ...
        if (value2.signum() < 0 || value2.bitLength() > 64) {
            z = false;
        } else {
            z = true;
        }
        Preconditions.checkArgument(z, "value (%s) is outside the range for an unsigned long value", value2);
