...
public final class Iterables {
    ...
    public static <T> Iterable<T> concat(Iterable<? extends T> a, Iterable<? extends T> b) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m1513of(a, b));
    }

    public static <T> Iterable<T> concat(Iterable<? extends T> a, Iterable<? extends T> b, Iterable<? extends T> c) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m1514of(a, b, c));
    }

    public static <T> Iterable<T> concat(Iterable<? extends T> a, Iterable<? extends T> b, Iterable<? extends T> c, Iterable<? extends T> d) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.m1515of(a, b, c, d));
    }

    public static <T> Iterable<T> concat(Iterable<? extends T>... inputs) {
        return concat((Iterable<? extends Iterable<? extends T>>) ImmutableList.copyOf((E[]) inputs));
    }
