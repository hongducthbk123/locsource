...
public class VersionUtil {
    ...
    public static Version mavenVersionFor(ClassLoader classLoader, String groupId, String artifactId) {
        InputStream pomPoperties = classLoader.getResourceAsStream("META-INF/maven/" + groupId.replaceAll("\\.", HttpUtils.PATHS_SEPARATOR) + HttpUtils.PATHS_SEPARATOR + artifactId + "/pom.properties");
