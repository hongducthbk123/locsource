...
import okhttp3.internal.p051ws.RealWebSocket.Streams;
...
public final class RealConnection extends Listener implements Connection {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0090, code lost:
        if (r14.rawSocket == null) goto L_0x0092;
     */
    ...
    public void connect(int r15, int r16, int r17, int r18, boolean r19, okhttp3.Call r20, okhttp3.EventListener r21) {
        ...
        L_0x003d:
            ...
            throw r3
        L_0x0079:
            okhttp3.Route r3 = r14.route     // Catch:{ IOException -> 0x00d3 }
            boolean r3 = r3.requiresTunnel()     // Catch:{ IOException -> 0x00d3 }
            ...
            r7 = r20
            r8 = r21
            r3.connectTunnel(r4, r5, r6, r7, r8)     // Catch:{ IOException -> 0x00d3 }
            java.net.Socket r3 = r14.rawSocket     // Catch:{ IOException -> 0x00d3 }
        ...
        L_0x00ab:
            ...
            r1 = r20
            r2 = r21
            r14.connectSocket(r15, r0, r1, r2)     // Catch:{ IOException -> 0x00d3 }
        L_0x00b4:
            r0 = r18
            r1 = r20
            r2 = r21
            r14.establishProtocol(r9, r0, r1, r2)     // Catch:{ IOException -> 0x00d3 }
            okhttp3.Route r3 = r14.route     // Catch:{ IOException -> 0x00d3 }
            java.net.InetSocketAddress r3 = r3.socketAddress()     // Catch:{ IOException -> 0x00d3 }
            okhttp3.Route r4 = r14.route     // Catch:{ IOException -> 0x00d3 }
            java.net.Proxy r4 = r4.proxy()     // Catch:{ IOException -> 0x00d3 }
            okhttp3.Protocol r5 = r14.protocol     // Catch:{ IOException -> 0x00d3 }
            r0 = r21
            r1 = r20
            r0.connectEnd(r1, r3, r4, r5)     // Catch:{ IOException -> 0x00d3 }
            goto L_0x0092
        L_0x00d3:
            r8 = move-exception
        ...
        L_0x011b:
            ...
            monitor-enter(r4)
            okhttp3.internal.http2.Http2Connection r3 = r14.http2Connection     // Catch:{ all -> 0x012c }
            int r3 = r3.maxConcurrentStreams()     // Catch:{ all -> 0x012c }
            r14.allocationLimit = r3     // Catch:{ all -> 0x012c }
