...
public abstract class BaseEncoding {
    ...
    static final class StandardBaseEncoding extends BaseEncoding {
        ...
        /* access modifiers changed from: 0000 */
        public CharMatcher padding() {
            return this.paddingChar == null ? CharMatcher.NONE : CharMatcher.m1479is(this.paddingChar.charValue());
        }
        ...
        public BaseEncoding withSeparator(String separator, int afterEveryChars) {
            ...
            Preconditions.checkArgument(padding().mo14368or(this.alphabet).matchesNoneOf(separator), "Separator cannot contain alphabet or padding characters");
