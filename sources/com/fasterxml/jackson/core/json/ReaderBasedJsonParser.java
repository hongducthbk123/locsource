...
public final class ReaderBasedJsonParser extends ParserBase {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=char, code=int, for r15v9, types: [char, int] */
