...
public final class Predicates {
    ...
    public static final Joiner COMMA_JOINER = Joiner.m1485on(',');
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f984f;

        /* renamed from: p */
        final Predicate<B> f985p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f985p = (Predicate) Preconditions.checkNotNull(p);
            this.f984f = (Function) Preconditions.checkNotNull(f);
        }

        public boolean apply(@Nullable A a) {
            return this.f985p.apply(this.f984f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (!this.f984f.equals(that.f984f) || !this.f985p.equals(that.f985p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f984f.hashCode() ^ this.f985p.hashCode();
        }

        public String toString() {
            return this.f985p.toString() + "(" + this.f984f.toString() + ")";
        }
    }
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m1493or(Iterable<? extends Predicate<? super T>> components) {
        return new OrPredicate(defensiveCopy(components));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m1494or(Predicate<? super T>... components) {
        return new OrPredicate(defensiveCopy((T[]) components));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m1492or(Predicate<? super T> first, Predicate<? super T> second) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m1491in(Collection<? extends T> target) {
    ...
    private static <T> List<T> defensiveCopy(T... array) {
        return defensiveCopy((Iterable<T>) Arrays.asList(array));
    }
