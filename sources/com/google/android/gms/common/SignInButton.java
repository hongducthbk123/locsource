...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zzd = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1209R.styleable.SignInButton, 0, 0);
        try {
            this.zza = obtainStyledAttributes.getInt(C1209R.styleable.SignInButton_buttonSize, 0);
            this.zzb = obtainStyledAttributes.getInt(C1209R.styleable.SignInButton_colorScheme, 2);
