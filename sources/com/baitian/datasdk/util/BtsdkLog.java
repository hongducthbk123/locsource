...
public class BtsdkLog {
    public static final String TAG = "BtDataSDK";
    ...
    /* renamed from: d */
    public static void m1417d(String format) {
        if (DebugUtils.getInstance().isLogFlag()) {
    ...
    /* renamed from: e */
    public static void m1419e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m1420e(Throwable tr, String format, Object... args) {
        if (DebugUtils.getInstance().isLogFlag()) {
    ...
    /* renamed from: e */
    public static void m1418e(String message) {
        if (DebugUtils.getInstance().isLogFlag()) {
    ...
    /* renamed from: p */
    public static void m1421p(String key, String value) {
        if (DebugUtils.getInstance().isLogFlag()) {
