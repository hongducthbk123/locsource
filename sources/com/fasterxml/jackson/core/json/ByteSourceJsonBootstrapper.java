...
import com.fasterxml.jackson.core.p046io.MergedStream;
import com.fasterxml.jackson.core.p046io.UTF32Reader;
...
public final class ByteSourceJsonBootstrapper {
    ...
    public JsonEncoding detectEncoding() throws IOException, JsonParseException {
        ...
        if (ensureLoaded(4)) {
            int quad = (this._inputBuffer[this._inputPtr] << Ascii.CAN) | ((this._inputBuffer[this._inputPtr + 1] & 255) << Ascii.DLE) | ((this._inputBuffer[this._inputPtr + 2] & 255) << 8) | (this._inputBuffer[this._inputPtr + 3] & 255);
            if (handleBOM(quad)) {
                foundEncoding = true;
