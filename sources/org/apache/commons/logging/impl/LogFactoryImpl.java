...
public class LogFactoryImpl extends LogFactory {
    ...
    private Log createLogFromClass(String logAdapterClassName, String logCategory, boolean affectState) throws LogConfigurationException {
        ...
        while (true) {
            ...
            try {
                if (isDiagnosticsEnabled()) {
                    String resourceName = new StringBuffer().append(logAdapterClassName.replace(FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX)).append(".class").toString();
                    if (currentCL != null) {
        ...
        if (logAdapter != null && affectState) {
            ...
            try {
                this.logMethod = logAdapterClass.getMethod(str, this.logMethodSignature);
