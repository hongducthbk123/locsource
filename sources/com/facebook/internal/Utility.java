...
public final class Utility {
    ...
    public static Bundle parseUrlQueryString(String queryString) {
        ...
        if (!isNullOrEmpty(queryString)) {
            for (String parameter : queryString.split(HttpUtils.PARAMETERS_SEPARATOR)) {
                String[] keyValuePair = parameter.split(HttpUtils.EQUAL_SIGN);
                try {
    ...
    private static void clearCookiesForDomain(Context context, String domain) {
        ...
        if (cookies != null) {
            for (String cookie : cookies.split(";")) {
                String[] cookieParts = cookie.split(HttpUtils.EQUAL_SIGN);
