...
public class AuthorizationCodeFlow {
    ...
    public static class Builder {
        ...
        public Builder(AccessMethod method2, HttpTransport transport2, JsonFactory jsonFactory2, GenericUrl tokenServerUrl2, HttpExecuteInterceptor clientAuthentication2, String clientId2, String authorizationServerEncodedUrl2) {
            setMethod(method2);
        ...
        public Builder setMethod(AccessMethod method2) {
    ...
    public AuthorizationCodeFlow(AccessMethod method2, HttpTransport transport2, JsonFactory jsonFactory2, GenericUrl tokenServerUrl, HttpExecuteInterceptor clientAuthentication2, String clientId2, String authorizationServerEncodedUrl2) {
    ...
    public final String getScopesAsString() {
        return Joiner.m1474on(' ').join(this.scopes);
    }
