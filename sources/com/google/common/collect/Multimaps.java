...
public final class Multimaps {
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() {
                        ...
                        public boolean hasNext() {
                            return this.f1008i == 0 && MapMultimap.this.map.containsKey(key);
                        }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        TransformedEntriesMultimap(Multimap<K, V1> fromMultimap2, EntryTransformer<? super K, ? super V1, V2> transformer2) {
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> result2 = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), (Function<? super V1, V2>) new Function<Collection<V>, Collection<V>>() {
        ...
        public Collection<Entry<K, V>> entries() {
            ...
            Collection<Entry<K, V>> result2 = Multimaps.unmodifiableEntries(this.delegate.entries());
    ...
    /* access modifiers changed from: private */
    public static <K, V> Collection<Entry<K, V>> unmodifiableEntries(Collection<Entry<K, V>> entries) {
