...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        this.dialog = new Dialog(getActivity(), C0998R.style.com_facebook_auth_dialog);
    ...
    public void setCurrentRequestState(RequestState currentRequestState2) {
        ...
        this.instructions.setCompoundDrawablesWithIntrinsicBounds(null, new BitmapDrawable(getResources(), DeviceRequestsHelper.generateQRCode(currentRequestState2.getAuthorizationUri())), null, null);
    ...
    public View initializeContentView(boolean isSmartLogin) {
        ...
        if (isSmartLogin) {
            view = inflater.inflate(C0998R.layout.com_facebook_smart_device_dialog_fragment, null);
        } else {
            view = inflater.inflate(C0998R.layout.com_facebook_device_auth_dialog_fragment, null);
        }
        this.progressBar = (ProgressBar) view.findViewById(C0998R.C1000id.progress_bar);
        this.confirmationCode = (TextView) view.findViewById(C0998R.C1000id.confirmation_code);
        ((Button) view.findViewById(C0998R.C1000id.cancel_button)).setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                DeviceAuthDialog.this.onCancel();
            }
        });
        this.instructions = (TextView) view.findViewById(C0998R.C1000id.com_facebook_device_auth_instructions);
        this.instructions.setText(Html.fromHtml(getString(C0998R.string.com_facebook_device_auth_instructions)));
        return view;
    }
    ...
    /* access modifiers changed from: private */
    public void presentConfirmation(final String userId, final PermissionsPair permissions, final String accessToken, String name) {
        String message = getResources().getString(C0998R.string.com_facebook_smart_login_confirmation_title);
        String continueFormat = getResources().getString(C0998R.string.com_facebook_smart_login_confirmation_continue_as);
        String cancel = getResources().getString(C0998R.string.com_facebook_smart_login_confirmation_cancel);
    ...
    /* access modifiers changed from: private */
    public void completeLogin(String userId, PermissionsPair permissions, String accessToken) {
