...
public class VersionInfo {
    ...
    public static final VersionInfo loadVersionInfo(String pckg, ClassLoader clsldr) {
        ...
        Properties vip = null;
        try {
            is = clsldr.getResourceAsStream(new StringBuffer().append(pckg.replace(FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX)).append(HttpUtils.PATHS_SEPARATOR).append(VERSION_PROPERTY_FILE).toString());
            if (is != null) {
