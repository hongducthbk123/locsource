        ...
        public RemoteViews generateContentView() {
            ...
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0041R.C0043id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0041R.C0043id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
