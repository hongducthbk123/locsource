...
import com.fasterxml.jackson.core.p046io.CharTypes;
import com.fasterxml.jackson.core.p046io.CharacterEscapes;
import com.fasterxml.jackson.core.p046io.IOContext;
import com.fasterxml.jackson.core.p046io.NumberOutput;
...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0027, code lost:
        ...
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r3[r4] = (byte) ((r0 >> 6) | com.google.android.vending.expansion.downloader.impl.DownloaderService.STATUS_RUNNING);
        r3 = r6._outputBuffer;
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r3[r4] = (byte) ((r0 & '?') | 128);
    ...
    public void writeRaw(char ch) throws IOException, JsonGenerationException {
        ...
        if (ch <= 127) {
            ...
            int i2 = this._outputTail;
            this._outputTail = i2 + 1;
            bbuf[i2] = (byte) ((ch >> 6) | DownloaderService.STATUS_RUNNING);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x001f, code lost:
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r0[r4] = (byte) ((r1 >> 6) | com.google.android.vending.expansion.downloader.impl.DownloaderService.STATUS_RUNNING);
        r4 = r6._outputTail;
        r6._outputTail = r4 + 1;
        r0[r4] = (byte) ((r1 & '?') | 128);
     */
        ...
        while (offset2 < end) {
            ...
            if (ch > 127) {
                if (ch <= 2047) {
                    ...
                    outputBuffer[outputPtr3] = (byte) ((ch >> 6) | DownloaderService.STATUS_RUNNING);
        ...
        while (offset2 < len2) {
            ...
            if (b2 < 0 || escCodes[b2] == 0) {
                ...
                if (escape > 0) {
                    ...
                    outputBuffer[outputPtr5] = (byte) escape;
                    outputPtr = outputPtr6;
                } else {
                    outputPtr = _writeGenericEscape(b2, outputPtr3);
                }
                outputPtr3 = outputPtr;
                offset2 = offset3;
            }
    ...
    public void _writeBinary(Base64Variant b64variant, byte[] input, int inputPtr, int inputEnd) throws IOException, JsonGenerationException {
        ...
        if (inputLeft > 0) {
            ...
            int b24 = input[inputPtr2] << Ascii.DLE;
            if (inputLeft == 2) {
    ...
    public int _writeBinary(Base64Variant b64variant, InputStream data, byte[] readBuffer, int bytesLeft) throws IOException, JsonGenerationException {
        ...
        int inputPtr5 = 0 + 1;
        int b24 = readBuffer[0] << Ascii.DLE;
