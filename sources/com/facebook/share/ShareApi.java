...
public final class ShareApi {
    ...
    public static void handleImagesOnAction(Bundle parameters) {
        String imageStr = parameters.getString(MessengerShareContentUtility.MEDIA_IMAGE);
        if (imageStr != null) {
            try {
                ...
                parameters.remove(MessengerShareContentUtility.MEDIA_IMAGE);
    ...
    private Bundle getSharePhotoCommonParameters(SharePhoto photo, SharePhotoContent photoContent) throws JSONException {
        ...
        if (!params.containsKey("tags") && !Utility.isNullOrEmpty((Collection<T>) photoContent.getPeopleIds())) {
