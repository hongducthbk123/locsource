...
public final class Maps {
    static final MapJoiner STANDARD_JOINER = Collections2.STANDARD_JOINER.withKeyValueSeparator(HttpUtils.EQUAL_SIGN);
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        class KeySet extends KeySet<K, V> {
            ...
            public boolean removeAll(Collection<?> c) {
                return removeIf(Predicates.m1491in(c));
            }

            public boolean retainAll(Collection<?> c) {
                return removeIf(Predicates.not(Predicates.m1491in(c)));
            }
    ...
    private static final class FilteredMapValues<K, V> extends Values<K, V> {
        ...
        public boolean removeAll(Collection<?> collection) {
            return removeIf(Predicates.m1491in(collection));
        }

        public boolean retainAll(Collection<?> collection) {
            return removeIf(Predicates.not(Predicates.m1491in(collection)));
        }
