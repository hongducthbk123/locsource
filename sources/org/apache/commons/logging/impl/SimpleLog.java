...
public class SimpleLog implements Log, Serializable {
    ...
    private static boolean getBooleanProperty(String name, boolean dephault) {
        String prop = getStringProperty(name);
        return prop == null ? dephault : ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase(prop);
    }
    ...
    public void log(int type, Object message, Throwable t) {
        ...
        if (showShortName) {
            if (this.shortLogName == null) {
                ...
                this.shortLogName = this.shortLogName.substring(this.shortLogName.lastIndexOf(HttpUtils.PATHS_SEPARATOR) + 1);
            }
