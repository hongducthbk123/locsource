...
public final class zzak {
    ...
    public final synchronized byte[] zza(int r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            r0 = 0
            r1 = r0
        L_0x0003:
            java.util.List<byte[]> r0 = r4.zzb     // Catch:{ all -> 0x002f }
            ...
            int r2 = r4.zzc     // Catch:{ all -> 0x002f }
            int r3 = r0.length     // Catch:{ all -> 0x002f }
            int r2 = r2 - r3
            r4.zzc = r2     // Catch:{ all -> 0x002f }
            java.util.List<byte[]> r2 = r4.zzb     // Catch:{ all -> 0x002f }
            r2.remove(r1)     // Catch:{ all -> 0x002f }
            java.util.List<byte[]> r1 = r4.zza     // Catch:{ all -> 0x002f }
        ...
        L_0x002f:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzak.zza(int):byte[]");
    }
}
