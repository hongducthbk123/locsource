...
import com.sensorsdata.analytics.android.sdk.java_websocket.drafts.Draft_76;
...
import com.sensorsdata.analytics.android.sdk.java_websocket.server.WebSocketServer.WebSocketWorker;
                ...
                if (this.role != Role.SERVER) {
                    ...
                    for (Draft d : this.knownDrafts) {
                        ...
                        try {
                            ...
                            if (d2.acceptHandshakeAsServer(handshake2) == HandshakeState.MATCHED) {
