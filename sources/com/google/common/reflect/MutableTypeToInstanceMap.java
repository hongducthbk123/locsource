...
public final class MutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    private static final class UnmodifiableEntry<K, V> extends ForwardingMapEntry<K, V> {
        ...
        public static <K, V> Iterator<Entry<K, V>> transformEntries(Iterator<Entry<K, V>> entries) {
        ...
        private UnmodifiableEntry(Entry<K, V> delegate2) {
            this.delegate = (Entry) Preconditions.checkNotNull(delegate2);
        }
    ...
    public <T extends B> T getInstance(Class<T> type) {
        return trustedGet(TypeToken.m1604of(type));
    }

    @Nullable
    public <T extends B> T putInstance(Class<T> type, @Nullable T value) {
        return trustedPut(TypeToken.m1604of(type), value);
    }
