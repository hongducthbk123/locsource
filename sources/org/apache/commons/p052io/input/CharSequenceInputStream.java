    ...
    public synchronized void reset() throws IOException {
        if (this.mark_cbuf != -1) {
            ...
            if (this.cbuf.position() != this.mark_cbuf) {
                throw new IllegalStateException("Unexpected CharBuffer postion: actual=" + this.cbuf.position() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + "expected=" + this.mark_cbuf);
            }
