...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(C0998R.layout.com_facebook_device_auth_dialog_fragment, null);
        ...
        ((TextView) view.findViewById(C0998R.C1000id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C0998R.string.com_facebook_device_auth_instructions)));
