...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isEndToEnd(String fieldName) {
        if ("Connection".equalsIgnoreCase(fieldName) || HTTP.CONN_KEEP_ALIVE.equalsIgnoreCase(fieldName) || "Proxy-Authenticate".equalsIgnoreCase(fieldName) || "Proxy-Authorization".equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.f1032TE.equalsIgnoreCase(fieldName) || "Trailers".equalsIgnoreCase(fieldName) || "Transfer-Encoding".equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.UPGRADE.equalsIgnoreCase(fieldName)) {
            return false;
        }
        return true;
    }
