...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        public V getValue(int index) {
            return ArrayTable.this.mo15162at(index, this.columnIndex);
        }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        /* access modifiers changed from: 0000 */
        public V getValue(int index) {
            return ArrayTable.this.mo15162at(this.rowIndex, index);
        }
    ...
    /* renamed from: at */
    public V mo15162at(int rowIndex, int columnIndex) {
    ...
    public V get(@Nullable Object rowKey, @Nullable Object columnKey) {
        ...
        return mo15162at(rowIndex.intValue(), columnIndex.intValue());
    }
        ...
        return new AbstractIndexedListIterator<Cell<R, C, V>>(size()) {
            ...
            public Cell<R, C, V> get(final int index) {
                return new AbstractCell<R, C, V>() {
                    ...
                    public V getValue() {
                        return ArrayTable.this.mo15162at(this.rowIndex, this.columnIndex);
                    }
                };
            }
        };
    ...
    public Map<R, V> column(C columnKey) {
        Preconditions.checkNotNull(columnKey);
        Integer columnIndex = (Integer) this.columnKeyToIndex.get(columnKey);
        return columnIndex == null ? ImmutableMap.m1530of() : new Column(columnIndex.intValue());
    }
    ...
    public Map<C, V> row(R rowKey) {
        Preconditions.checkNotNull(rowKey);
        Integer rowIndex = (Integer) this.rowKeyToIndex.get(rowKey);
        return rowIndex == null ? ImmutableMap.m1530of() : new Row(rowIndex.intValue());
    }
