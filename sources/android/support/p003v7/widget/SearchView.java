...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(a.getResourceId(C0247R.styleable.SearchView_layout, C0247R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0247R.C0249id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0247R.C0249id.search_edit_frame);
        this.mSearchPlate = findViewById(C0247R.C0249id.search_plate);
        this.mSubmitArea = findViewById(C0247R.C0249id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0247R.C0249id.search_button);
        this.mGoButton = (ImageView) findViewById(C0247R.C0249id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0247R.C0249id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0247R.C0249id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0247R.C0249id.search_mag_icon);
        ...
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0247R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0247R.styleable.SearchView_suggestionRowLayout, C0247R.layout.abc_search_dropdown_item_icons_2line);
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0247R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0247R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0247R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0247R.dimen.abc_dropdownitem_text_padding_left) : 0;
