...
import com.btgame.sdk.util.CodecUtils;
...
public class HttpDataUtil {
    ...
    public static String readJsonData(InputStream in) {
        ...
        try {
            ...
            BtsdkLog.m1423d("uncompress " + e2.getMessage());
        ...
        BtsdkLog.m1423d("decode respone");
        if (tmp == null || tmp.length() <= 0) {
            return null;
        }
        BtsdkLog.m1423d("respone = " + tmp);
        return tmp;
    }
