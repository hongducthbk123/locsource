...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    enum EntryFactory {
        ...
        static EntryFactory getFactory(Strength keyStrength, boolean expireAfterWrite, boolean evictsBySize) {
            ...
            return factories[keyStrength.ordinal()][c | i];
        }
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x0044, code lost:
            if (r12.map.valueEquivalence.equivalent(r15, r3) == false) goto L_0x006a;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0046, code lost:
            r0 = com.google.common.collect.MapMaker.RemovalCause.EXPLICIT;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0048, code lost:
            r12.modCount++;
            enqueueNotification(r2, r14, r3, r0);
            r6 = r12.count - 1;
            r8.set(r5, removeFromChain(r4, r1));
            r12.count = r6;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0060, code lost:
            if (r0 != com.google.common.collect.MapMaker.RemovalCause.EXPLICIT) goto L_0x0063;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0062, code lost:
            r10 = true;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:19:0x006e, code lost:
            if (isCollected(r9) == false) goto L_0x0073;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:20:0x0070, code lost:
            r0 = com.google.common.collect.MapMaker.RemovalCause.COLLECTED;
         */
        ...
        public boolean remove(java.lang.Object r13, int r14, java.lang.Object r15) {
            /*
                ...
                r10 = 0
                r12.lock()
                r12.preWriteCleanup()     // Catch:{ all -> 0x0086 }
                int r11 = r12.count     // Catch:{ all -> 0x0086 }
                int r6 = r11 + -1
                java.util.concurrent.atomic.AtomicReferenceArray<com.google.common.collect.MapMakerInternalMap$ReferenceEntry<K, V>> r8 = r12.table     // Catch:{ all -> 0x0086 }
                int r11 = r8.length()     // Catch:{ all -> 0x0086 }
                int r11 = r11 + -1
                r5 = r14 & r11
                java.lang.Object r4 = r8.get(r5)     // Catch:{ all -> 0x0086 }
                com.google.common.collect.MapMakerInternalMap$ReferenceEntry r4 = (com.google.common.collect.MapMakerInternalMap.ReferenceEntry) r4     // Catch:{ all -> 0x0086 }
                r1 = r4
            L_0x001c:
                if (r1 == 0) goto L_0x007f
                java.lang.Object r2 = r1.getKey()     // Catch:{ all -> 0x0086 }
                int r11 = r1.getHash()     // Catch:{ all -> 0x0086 }
                if (r11 != r14) goto L_0x007a
                if (r2 == 0) goto L_0x007a
                com.google.common.collect.MapMakerInternalMap<K, V> r11 = r12.map     // Catch:{ all -> 0x0086 }
                com.google.common.base.Equivalence<java.lang.Object> r11 = r11.keyEquivalence     // Catch:{ all -> 0x0086 }
                boolean r11 = r11.equivalent(r13, r2)     // Catch:{ all -> 0x0086 }
                if (r11 == 0) goto L_0x007a
                com.google.common.collect.MapMakerInternalMap$ValueReference r9 = r1.getValueReference()     // Catch:{ all -> 0x0086 }
                java.lang.Object r3 = r9.get()     // Catch:{ all -> 0x0086 }
                com.google.common.collect.MapMakerInternalMap<K, V> r11 = r12.map     // Catch:{ all -> 0x0086 }
                com.google.common.base.Equivalence<java.lang.Object> r11 = r11.valueEquivalence     // Catch:{ all -> 0x0086 }
                boolean r11 = r11.equivalent(r15, r3)     // Catch:{ all -> 0x0086 }
                if (r11 == 0) goto L_0x006a
                com.google.common.collect.MapMaker$RemovalCause r0 = com.google.common.collect.MapMaker.RemovalCause.EXPLICIT     // Catch:{ all -> 0x0086 }
            L_0x0048:
                int r11 = r12.modCount     // Catch:{ all -> 0x0086 }
                int r11 = r11 + 1
                r12.modCount = r11     // Catch:{ all -> 0x0086 }
                r12.enqueueNotification(r2, r14, r3, r0)     // Catch:{ all -> 0x0086 }
                com.google.common.collect.MapMakerInternalMap$ReferenceEntry r7 = r12.removeFromChain(r4, r1)     // Catch:{ all -> 0x0086 }
                int r11 = r12.count     // Catch:{ all -> 0x0086 }
                int r6 = r11 + -1
                r8.set(r5, r7)     // Catch:{ all -> 0x0086 }
                r12.count = r6     // Catch:{ all -> 0x0086 }
                com.google.common.collect.MapMaker$RemovalCause r11 = com.google.common.collect.MapMaker.RemovalCause.EXPLICIT     // Catch:{ all -> 0x0086 }
            ...
            L_0x0069:
                return r10
            L_0x006a:
                boolean r11 = r12.isCollected(r9)     // Catch:{ all -> 0x0086 }
                if (r11 == 0) goto L_0x0073
                com.google.common.collect.MapMaker$RemovalCause r0 = com.google.common.collect.MapMaker.RemovalCause.COLLECTED     // Catch:{ all -> 0x0086 }
                goto L_0x0048
            L_0x0073:
                r12.unlock()
                r12.postWriteCleanup()
                goto L_0x0069
            L_0x007a:
                com.google.common.collect.MapMakerInternalMap$ReferenceEntry r1 = r1.getNext()     // Catch:{ all -> 0x0086 }
                goto L_0x001c
            L_0x007f:
                r12.unlock()
                r12.postWriteCleanup()
